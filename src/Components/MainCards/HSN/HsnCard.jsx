...
//   console.log("rowIdhsn", rowId);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await axios.post(
        `https://admin.dms.zacoinfotech.com/api/edit-hsn/${rowId}`,
        formDataToSend
      );
  ...
  const handleDeleteID = async () => {
    try {
      const response = await axios.delete(
        `https://admin.dms.zacoinfotech.com/api/delete-hsn/${rowId}`
      );
      ...
      console.error("Error deleting hsn data:", error);
      toast.error("Failed to delete hsn. Please try again.", {
        position: "top-right",
        autoClose: 2000,
      });
  ...
  const handleCreateOpen = async () => {
    ...
    //   console.log("dd", response.data);
      ...
      toast.error("Failed to load hsn data. Please try again.", {
        position: "top-right",
        autoClose: 2000,
      });
    }
