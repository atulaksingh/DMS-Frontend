...
export default function ProductDescriptionCard({ rowId ,fetchClients}) {
  ...
  const handleDeleteID = async () => {
    try {
      const response = await axios.delete(
        `https://admin.dms.zacoinfotech.com/api/delete-product-description/${rowId}`
      );
  ...
  const handleViewOpen = async () => {
    ...
    try {
      const response = await axios.get(
        `https://admin.dms.zacoinfotech.com/api/edit-product-description/${rowId}`
      );
  ...
  useEffect(() => {
    const fetchBankDetails = async () => {
      try {
        const response = await axios.get(
          `https://admin.dms.zacoinfotech.com/api/create-product-description`
        );
