...
//   console.log("rowIdproduct", rowId);
  ...
  const handleDeleteID = async () => {
    try {
      const response = await axios.delete(
        `https://admin.dms.zacoinfotech.com/api/delete-product/${rowId}`
      );
  ...
  const handleViewOpen = async() => {
    ...
    try {
        const response = await axios.get(
          `https://admin.dms.zacoinfotech.com/api/edit-product/${rowId}`
        );
  ...
  useEffect(() => {
    const fetchBankDetails = async () => {
      try {
        const response = await axios.get(
          `https://admin.dms.zacoinfotech.com/api/create-product`
        );
